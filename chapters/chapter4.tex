...
\begin{enumerate}
    ...
    \item \textbf{Collecte de Données :} Téléchargement séquentiel des cours de clôture ajustés pour les actifs du portefeuille (\texttt{AAPL}, \texttt{MSFT}, \texttt{GOOGL}, \texttt{JPM}, \texttt{PG}) et pour le benchmark (\texttt{^GSPC}) de 2015 à 2024. Un mécanisme robuste de données alternatives réalistes est prévu en cas d'erreur réseau ou de verrou de base de données.
